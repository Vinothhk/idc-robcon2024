...
def generate_launch_description():
    ...
    robot_controllers=os.path.join(get_package_share_directory("harvester"),"config","arm_controller.yaml")
    ...
    joint_state_broadcaster_spawner = Node(
        package="controller_manager",
        executable="spawner",
        arguments=["arm_joint_state_broadcaster", "--controller-manager", "/controller_manager"],
    )
